        ...
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="px-4 pe-sm-0 ps-sm-5"><span class="badge bg-danger">Limited Offer</span>
                    ...
                    </div><a class="btn btn-accent" href="{{ route('front.offers') }}">View offers<i class="ci-arrow-right fs-ms ms-1"></i></a>
                </div>
            </div>
            <div class="col-md-7">
                <img src="{{asset(env('PUBLIC_PATH' , '').'img/home/banners/offer.jpg')}}" alt="iPad Pro Offer"></div>
        </div>
    </div>
</section>
